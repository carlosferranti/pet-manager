...
public class CriarInscricaoCandidatoCommandValidator : ApplicationRequestValidator<CriarInscricaoCandidatoCommand, EntityKeyDto?>
{
    ...
    public CriarInscricaoCandidatoCommandValidator(
        ...
        : base(notificationContext)
    {
        ...
        When(x => x.FichaKey.HasValue, () =>
        {
            RuleFor(x => x.FichaKey!.Value)
        ...
        When(x => x.InfoOrigem != null, () =>
        {
           When(x => !string.IsNullOrEmpty(x.InfoOrigem!.Url), () =>
           {
               RuleFor(x => x.InfoOrigem!.Url)
                .MaximumLength(LimiteCaracteresUrl)
                     .WithMessage("A URL da origem deve ter no máximo {MaxLength} caracteres.");
           });
        });
        #endregion
