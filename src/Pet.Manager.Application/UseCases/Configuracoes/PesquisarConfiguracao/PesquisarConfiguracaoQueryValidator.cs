...
public class PesquisarConfiguracaoQueryValidator : ApplicationRequestValidator<PesquisarConfiguracaoQuery, ResultadoPaginadoDto<ConfiguracaoDto>>
{
    public PesquisarConfiguracaoQueryValidator(INotificationContext notificationContext) 
