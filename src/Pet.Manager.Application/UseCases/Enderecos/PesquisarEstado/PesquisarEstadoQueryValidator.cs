...
public class PesquisarEstadoQueryValidator : ApplicationRequestValidator<PesquisarEstadoQuery, ResultadoPaginadoDto<EstadoDto>>
{
    public PesquisarEstadoQueryValidator(INotificationContext notificationContext)
