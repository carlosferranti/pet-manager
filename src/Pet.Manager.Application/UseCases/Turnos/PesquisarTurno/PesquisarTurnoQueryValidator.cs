...
public class PesquisarTurnoQueryValidator : ApplicationRequestValidator<PesquisarTurnoQuery, ResultadoPaginadoDto<TurnoDto>>
{
    public PesquisarTurnoQueryValidator(INotificationContext notificationContext) 
