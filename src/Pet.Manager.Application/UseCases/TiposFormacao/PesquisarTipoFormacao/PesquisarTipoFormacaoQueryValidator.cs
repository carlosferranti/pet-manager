...
public class PesquisarTipoFormacaoQueryValidator : ApplicationRequestValidator<PesquisarTipoFormacaoQuery, ResultadoPaginadoDto<TipoFormacaoDto>>
{
    public PesquisarTipoFormacaoQueryValidator(INotificationContext notificationContext)
