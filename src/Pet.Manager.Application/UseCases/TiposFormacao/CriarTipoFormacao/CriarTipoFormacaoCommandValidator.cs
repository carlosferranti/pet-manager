...
public class CriarTipoFormacaoCommandValidator : ApplicationRequestValidator<CriarTipoFormacaoCommand, EntityKeyDto?>
{
    ...
    public CriarTipoFormacaoCommandValidator(
        ...
        : base(notificationContext)
    {
        ...
        RuleFor(x => x.Nome)
            .NotEmpty()
            .WithMessage("O nome do tipo de formação é obrigatório.")
            .MaximumLength(LimiteMaximoNome)
            .WithMessage("O nome do tipo de formação deve ter no máximo {MaxLength} caracteres.");
