...
public class CriarMarcaCommandValidator : ApplicationRequestValidator<CriarMarcaCommand, EntityKeyDto?>
{
        ...
        : base(notificationContext)
    {
        ...
        RuleFor(x => x.Nome)
            ...
            .WithMessage("O nome da marca deve ter no máximo {MaxLength} caracteres.");

        RuleFor(x => x.Sigla)
            .NotEmpty().WithMessage("A sigla da marca é obrigatória.")
            .MaximumLength(LimiteMaximoSigla)
            .WithMessage("A sigla da marca deve ter no máximo {MaxLength} caracteres.");
