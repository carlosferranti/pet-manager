...
public class MemoriaCacheTest : BaseCacheTest
{
    [Fact]
    ...
    public async Task DeveObterObjetosDeMesmoIdEmCachesDiferentesAsync()
    {
        await ExecutarComSemaforoAsync(async () =>
        {
            var cache1 = CriarMemoriaCache<string>(BuscarItemAsync, true, id: "1");
            var cache2 = CriarMemoriaCache<string>(BuscarItemAsync, true, id: "1");
    ...
    public async Task DeveAdicionarERemoverItemDoCacheAsync()
    {
        await ExecutarComSemaforoAsync(async () =>
        {
            ...
            var cache = CriarMemoriaCache<string>(BuscarItemAsync, true, id: cacheId);
            ...
            var cacheParaRemover = CriarMemoriaCacheParaRemover<string>(true, id: cacheId);
