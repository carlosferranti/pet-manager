...
public class PesquisarCursoQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarCursoQueryValidator _validationRules;

    public PesquisarCursoQueryValidatorTests()
    {
        _validationRules = new PesquisarCursoQueryValidator(_notificationContextMock.Object);
    }

    [Fact]
    public async Task DeveValidarPaginacaoObrigatoriaAsync()
    {
        var command = new PesquisarCursoQuery
        {
            Paginacao = null!,
        };
