...
public class PesquisarFichaQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarFichaQueryValidator _validationRules;

    public PesquisarFichaQueryValidatorTests()
    {
    ...
    {
        var command = new PesquisarFichaQuery
        {
            Paginacao = null!,
        };
