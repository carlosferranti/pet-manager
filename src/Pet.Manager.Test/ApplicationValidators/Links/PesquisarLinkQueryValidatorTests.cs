...
public class PesquisarLinkQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarLinkQueryValidator _validationRules;

    public PesquisarLinkQueryValidatorTests()
    {
    ...
    {
        var command = new PesquisarLinkQuery
        {
            Paginacao = null!,
        };
