...
public class PesquisarDeficienciaQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarDeficienciaQueryValidator _validationRules;

    public PesquisarDeficienciaQueryValidatorTests()
    {
        _validationRules = new PesquisarDeficienciaQueryValidator(_notificationContextMock.Object);
    }

    [Fact]
    public async Task DeveValidarPaginacaoObrigatoriaAsync()
    {
        var command = new PesquisarDeficienciaQuery
        {
            Paginacao = null!,
        };
