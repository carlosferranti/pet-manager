...
public class PesquisarFormaEntradaQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarFormaEntradaQueryValidator _validationRules;

    public PesquisarFormaEntradaQueryValidatorTests()
    {
    ...
    {
        var command = new PesquisarFormaEntradaQuery
        {
            Paginacao = null!,
        };
