...
public class PesquisarTurnoQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarTurnoQueryValidator _validationRules;

    public PesquisarTurnoQueryValidatorTests()
    {
        _validationRules = new PesquisarTurnoQueryValidator(_notificationContextMock.Object);
    }

    [Fact]
    public async Task DeveValidarPaginacaoObrigatoriaAsync()
    {
        var command = new PesquisarTurnoQuery
        {
            Paginacao = null!,
        };
