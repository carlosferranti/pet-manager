...
public class PesquisarTipoFormacaoQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarTipoFormacaoQueryValidator _validationRules;

    public PesquisarTipoFormacaoQueryValidatorTests()
    {
        _validationRules = new PesquisarTipoFormacaoQueryValidator(_notificationContextMock.Object);
    }

    [Fact]
    public async Task DeveValidarPaginacaoObrigatoriaAsync()
    {
        var command = new PesquisarTipoFormacaoQuery
        {
            Paginacao = null!,
        };
