...
public class PesquisarProdutoQueryValidatorTests
{
    private readonly Mock<INotificationContext> _notificationContextMock = new();
    private readonly PesquisarProdutoQueryValidator _validationRules;

    public PesquisarProdutoQueryValidatorTests()
    {
        _validationRules = new PesquisarProdutoQueryValidator(_notificationContextMock.Object);
    }

    [Fact]
    public async Task DeveValidarPaginacaoObrigatoriaAsync()
    {
        var query = new PesquisarProdutoQuery
        {
            Paginacao = null!,
        };
